...
This project showcases API testing with Postman, offering a set of tests to verify different API endpoints.
...
## API Documentation:
- https://documenter.getpostman.com/view/39004245/2sAYJ7gJoB
...
2. Clone the repository:
 ```console 
  git clone https://github.com/koli-pal/Automated_API_Testing_with_Newman_Report.git
```
...
```console 
newman run API_Testing.postman_collection.json -e API_Testing.postman_environment.json 
```
- Run Command for Report: 
```console 
newman run API_Testing.postman_collection.json -e API_Testing.postman_environment.json -r htmlextra
```
```console 
newman run API_Testing.postman_collection.json -e API_Testing.postman_environment.json -r html
```
